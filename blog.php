		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
		   					<h2 class="heading-section">Ultimas Notícias</h2>
		   					<p>Obtenha informações de fontes confiáveis, acompanhe conosoco as últimas notícias no âmbito legal.</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="blog/direito-do-trabalho.php"><img class="img-responsive" src="images/a4.png" alt=""></a>
						<div class="blog-text">
							<span class="posted_on">Data Noticia</span>
							<h3><a href="blog/direito-do-trabalho.php">Direito do Trabalho</a></h3>
