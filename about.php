...
<body>
	...
	<div id="page">
						...
						<div class="container">
							<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
								<div class="slider-text-inner desc">
									<h2 class="heading-section">Uma História de Sucesso</h2>
									<p>Mais de 15 anos atuando no ramo Previdenciário.</p>
								</div>
							</div>
						</div>
					</li>
		...
		<div class="container corrigeTime">
			<div id="fh5co-practice" class="fh5co-bg-section corrSection">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
						<h2 class="titleCor2">Nossa História em Detalhes</h2>
			...
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
						...
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, mollitia quae ut illo, a
							quasi exercitationem vitae fugiat aliquid ipsam quos quam voluptatem qui molestiae est
							officia! Rerum, placeat suscipit!</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
						<div class="fh5co-staff">
							...
							<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eveniet eius facere, esse
								voluptas provident eos consectetur minima, quasi distinctio autem voluptatibus
								architecto placeat aspernatur magnam. Sapiente beatae nisi culpa. Dignissimos!</p>
							...
							<div class="owl-carousel owl-carousel-fullwidth">
								<div class="item">
									<div class="testimony-slide active text-center">
										...
										<span>Fulano</span>
										<blockquote>
											<p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus
												ullam dignissimos perspiciatis optio corrupti laudantium, officia,
												quidem eaque beatae cumque hic nulla quia aperiam eligendi deleniti.
												Nulla saepe quasi quibusdam!&rdquo;</p>
										</blockquote>
									</div>
								</div>
								<div class="item">
